...
public final class PreferencesProvider {
    ...
    public static class Interface {
        ...
        public static class General {
            ...
            public static boolean getDarkTheme(boolean def) {
            	return getBoolean("drak_theme", def);
            }
            public static void setDarkTheme(Context ctx, boolean value) {
            	setBoolean(ctx, "drak_theme", value);
            }
